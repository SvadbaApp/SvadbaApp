...
if (isset($_POST['update'])) {
    //update expense
    $queryUpdate = $conn->prepare("UPDATE guests SET TITLE = :title, PRICE = :price WHERE ID = :id AND USER_ID = :userId");
...
if (isset($_POST['delete'])) {
    //delete expense
    $queryDelete = $conn->prepare("DELETE FROM guests WHERE ID = :id AND USER_ID = :userId AND TITLE = :title AND PRICE = :price");
...
if (isset($_POST['insert'])) {
    //insert expense
    $queryInsert = $conn->prepare("INSERT INTO guests (USER_ID, TITLE, PRICE) VALUES (:userId, :title, :price)");
